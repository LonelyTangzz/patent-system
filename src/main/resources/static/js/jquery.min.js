...
(function (e, t) {
    ...
    v.Callbacks = function (e) {
        ...
        s = i.createElement("select"), o = s.appendChild(i.createElement("option")), u = p.getElementsByTagName("input")[0], r.style.cssText = "top:1px;float:left;opacity:.5", t = {
            ...
            style: /top/.test(r.getAttribute("static.css.user.style")),
    ...
    v.event = {
        ...
        dispatch: function (n) {
            ...
            if (m && (!n.button || n.type !== "click")) for (s = n.target; s != this; s = s.parentNode || this) if (s.disabled !== !0 || n.type !== "click") {
                u = {}, f = [];
                for (r = 0; r < m; r++) c = d[r], h = c.selector, u[h] === t && (u[h] = c.needsContext ? v(h, this).templates(s) >= 0 : v.find(h, this, null, [s]).length), u[h] && f.push(c);
    ...
    v.fn.extend({
        find: function (e) {
            ...
            return !!e && (typeof e == "string" ? st.test(e) ? v(e, this.context).templates(this[0]) >= 0 : v.filter(e, this).length > 0 : this.filter(e).length > 0)
